...
save_csv(right_subflank_left_prediction_data, out_path + "/right_subflank_left_prediction_data.csv")
save_csv(gap_left_prediction_data, out_path + "/gap_left_prediction_data.csv")
save_csv(left_subflank_right_prediction_data, out_path + "/left_subflank_right_prediction_data.csv")
save_csv(gap_right_prediction_data, out_path + "/gap_right_prediction_data.csv")