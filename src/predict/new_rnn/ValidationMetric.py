...
class ValidationMetric(keras.callbacks.Callback):
    def __init__(self, reference_seqs, min_seed_length, spacing, embedding_dim, latent_dim, epochs, early_stopping=False):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        validation_metrics = self._percentage_until_mismatch()
