...
class DataGenerator(keras.utils.Sequence):
    def __init__(self, reads, min_seed_length, batch_size=64, spacing=0, log_samples=False, log_training=False,
        ...
        if base_path is not None:
            ...
            if os.name == 'nt':
                directory_path = 'E:\\Users\\Documents\\School Year 18-19\\Term 1\\CPSC 449\\Sealer_NN\\src\\predict\\new_rnn\\out\\'
            else:
                directory_path = '/home/echen/Desktop/Projects/Sealer_NN/src/predict/new_rnn/out/'
