...
def main():
    ...
    input_seq_train, input_quality_train, output_seq_train, shifted_output_train, train_input_stats_map = extract_read_matrix(training_paths,
                                                                                                    input_length,
                                                                                                    spacing,
                                                                                                    bases_to_predict,
    ...
    input_seq_valid, input_quality_valid, output_seq_valid, shifted_output_valid, valid_input_stats_map = extract_read_matrix(validation_paths,
                                                                                                    input_length,
                                                                                                    spacing,
                                                                                                    bases_to_predict,
                                                                                                    include_reverse_complement,
