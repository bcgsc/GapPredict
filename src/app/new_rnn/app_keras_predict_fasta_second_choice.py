...
def main():
    ...
    predicted_string_with_seed, basewise_probabilities = helper.regenerate_sequence_second_choice(implementation, min_seed_length, model, sampler_model, offset_sequence)
