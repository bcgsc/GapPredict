...
def main():
    ...
    save_fig(df, "valid_acc", output_folder, "valid_acc.png")
    save_fig(df, "train_acc", output_folder, "train_acc.png")
    save_fig(df, "valid_loss", output_folder, "valid_loss.png")
    save_fig(df, "train_loss", output_folder, "train_loss.png")
    save_fig(df, "best_epoch", output_folder, "best_epoch.png")
